...
void SQM_client::build_network()
{
    ...
    try
    {
        ...
        // (2, 2, 2)
        parent_state[I_Coupling] = 2;
        set_node_probability(bn, Modification, 2, parent_state, 0.7);
        set_node_probability(bn, Modification, 1, parent_state, 0.2);
        set_node_probability(bn, Modification, 0, parent_state, 0.1);
        ...
        set_node_probability(bn, Understanding, 2, parent_state, 0.6);
        set_node_probability(bn, Understanding, 1, parent_state, 0.29);
        ...
        set_node_probability(bn, Understanding, 2, parent_state, 0.25);
        set_node_probability(bn, Understanding, 1, parent_state, 0.25);
        ...
        set_node_probability(bn, Understanding, 2, parent_state, 0.25);
        set_node_probability(bn, Understanding, 1, parent_state, 0.6);
        set_node_probability(bn, Understanding, 0, parent_state, 0.15);
        ...
        set_node_probability(bn, Testing, 1, parent_state, 0.4);
        ...
        set_node_probability(bn, Analysis, 2, parent_state, 0.2);
        set_node_probability(bn, Analysis, 1, parent_state, 0.4);
        ...
        set_node_probability(bn, QA, 1, parent_state, 0.4);
        set_node_probability(bn, QA, 0, parent_state, 0.1);

        parent_state[Testing] = 1;
        set_node_probability(bn, QA, 2, parent_state, 0.3);
        set_node_probability(bn, QA, 1, parent_state, 0.3);
        set_node_probability(bn, QA, 0, parent_state, 0.4);
        ...
        set_node_probability(bn, Maintenance, 1, parent_state, 0.45);
